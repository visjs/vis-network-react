...
var Graph = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Graph, [{
    ...
    value: function componentDidMount() {
      this.edges = new _visData.DataSet(this.props.data.edges);
      this.nodes = new _visData.DataSet(this.props.data.nodes);
      this.updateGraph();
    }
  }, {
    key: "shouldComponentUpdate",
    value: function shouldComponentUpdate(nextProps, nextState) {
      var nodesChange = !(0, _isEqual["default"])(this.props.data.nodes, nextProps.data.nodes);
      var edgesChange = !(0, _isEqual["default"])(this.props.data.edges, nextProps.data.edges);
      ...
      if (nodesChange) {
        ...
        var nodesRemoved = (0, _differenceWith["default"])(this.props.data.nodes, nextProps.data.nodes, idIsEqual);
        var nodesAdded = (0, _differenceWith["default"])(nextProps.data.nodes, this.props.data.nodes, idIsEqual);
        var nodesChanged = (0, _differenceWith["default"])((0, _differenceWith["default"])(nextProps.data.nodes, this.props.data.nodes, _isEqual["default"]), nodesAdded);
        this.patchNodes({
      ...
      if (edgesChange) {
        var edgesRemoved = (0, _differenceWith["default"])(this.props.data.edges, nextProps.data.edges, _isEqual["default"]);
        var edgesAdded = (0, _differenceWith["default"])(nextProps.data.edges, this.props.data.edges, _isEqual["default"]);
        var edgesChanged = (0, _differenceWith["default"])((0, _differenceWith["default"])(nextProps.data.edges, this.props.data.edges, _isEqual["default"]), edgesAdded);
        this.patchEdges({
    ...
    value: function updateGraph() {
      ...
      this.Network = new _visNetwork.Network(this.container.current, {
        nodes: this.nodes,
        edges: this.edges
      }, options);
